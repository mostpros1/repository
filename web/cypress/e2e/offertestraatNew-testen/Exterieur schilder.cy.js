...
const terms = [
    'Buitenmuren/Gevels Schilderen',
    'Kozijnen/Deuren/Luiken Schilderen',
    'Houtwerk Behandelen (Lakken/Beitsen)',
    'Grondverf/Primer Aanbrengen',
    'Beschadigde/Verouderde Verflagen Herstellen',
    'Oppervlakken Voorbereiden (Schuren, Plamuren, Reinigen)',
    'Houtrot/Schimmel Behandelen',
    'Speciale Afwerkingen (Faux Finishes)',
    'Spuitapparatuur Gebruik (Grote Oppervlakken)',
    'Steigers/Ladders voor Hoogtewerk',
    'Kleurkeuzes/Verftype Advies',
    'Verf/Materialen Estimatie',
    'Gereedschappen/Materialen Onderhoud',
    'Beschermende Maatregelen (Maskers, Handschoenen)',
    'Samenwerking Andere Vakmensen',
    'Waterdichte Coatings/Sealants Aanbrengen',
    'Potentiële Problemen Aanpakken (Blaarvorming, Verkleuring)',
    'Garantie op Werk',
    'Eerder Geschilderde Oppervlakken Inspecteren',
    'Onderhoudsadvies aan Klanten'
  ];

describe('Testing "Exterieur schilder"', () => {
