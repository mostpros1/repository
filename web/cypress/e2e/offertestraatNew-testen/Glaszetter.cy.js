...
const terms = [
    'Nieuw Glas in Ramen/Deuren Plaatsen',
    'Gebroken/Beschadigd Glas Vervangen',
    'Isolerend Dubbelglas/HR++ Glas Installeren',
    'Veiligheidsglas/Inbraakwerend Glas Plaatsen',
    'Glazen Deuren/Scheidingswanden Installeren',
    'Glas-in-Lood Ramen Aanbrengen',
    'Spiegels/Spiegelwanden Monteren',
    'Glazen Douchewanden/-Cabines Plaatsen',
    'Geluidswerend Glas Installeren',
    'Ramen Afdichten (Tocht/Lekkage)',
    'Advies over Glassoorten/Toepassingen',
    'Glasplaten Op Maat Snijden',
    'Kleine Reparaties (Krassen Verwijderen)',
    'Getint/Gefolieerd Glas Installeren',
    'Zonwerend Glas Plaatsen',
    'Brandwerend Glas en Speciale Glassoorten',
    'Raamdecoratie/Zonwering Tussen Dubbelglas',
    'Glas-in-Lood Panelen Herstellen',
    'Oud Glas Verwijderen/Afvoeren'
  ];

describe('Testing "Glaszetter"', () => {
