...
const terms = [
    'Beveiligingsadvies (Woningen, Bedrijven, Evenementen)',
    'Alarmsystemen Installatie',
    'Camerasystemen Installatie',
    'Toegangscontrolesystemen Installatie',
    'Brandbeveiliging/Rookmelders Installatie',
    'Beveiligingssystemen/Domotica Integratie',
    'Beveiligingssystemen Periodieke Controles/Onderhoud',
    'Bewegingssensoren Installatie',
    'Beveiligde Netwerken/Cybersecurity Opzetten',
    'Risico\'s/Kwetsbaarheden Beoordeling',
    'Beveiligingsbewustzijn/Preventie Training',
    'Specifieke Gebieden Beveiliging (Kluizen, Datarooms)',
    'Nood-/Ontruimingsplannen Opzetten',
    'Fysieke Barrières Consultatie (Hekken, Poorten, Sloten)',
    'Intercomsystemen/Videobellen Installatie',
    'Smart Home Systemen Beveiligingsintegratie',
    'Beveiligingsaudits/-evaluaties',
    'Persoonlijke Beveiliging/Lijfwacht Diensten',
    'Beveiligingsproducten Verkoop/Advies',
    'Reactie op Alarmmeldingen/Coördinatie met Hulpdiensten'
  ];

describe('Testing "Beveiligingsspecialist"', () => {
