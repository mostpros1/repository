...
const terms = [
    ...
    'Muurvoorbereiding (Egaliseren, Schuren)',
    'Voorstrijk/Primer Aanbrengen',
    'Behangrollen Knippen/Meten',
    'Behanglijm Aanbrengen',
    'Behang Plaatsing',
    'Behang Gladstrijken (Luchtbellen)',
    'Afwerking Hoeken/Randen/Stopcontacten',
    'Verschillende Behangsoorten',
    'Patronen/Naden Aansluiten',
    'Decoratieve Wandbekleding (Muurstickers)',
    'Plafonds/Schuine Wanden Behangen',
    'Behangtype/Ontwerp Advies',
    'Kleuren/Patronen Mengen',
    'Speciale Technieken (Fotobehang, 3D)',
    'Muurbeschadigingen Herstellen',
    'Gereedschap Onderhoud',
    'Nazorg/Behang Onderhoudsinstructies',
    'Beschermende Coatings Over Behang',
    'Periodiek Onderhoud/Behang Vervanging'
  ];

describe('Testing "Behanger"', () => {
