...
const terms = [
    'Gevels Reinigen',
    'Metselwerk Voegen/Hervoegen',
    'Gevelschade Repareren',
    'Gevels Zandstralen/Chemisch Reinigen',
    'Gevels Impregneren (Vochtwerend)',
    'Gevelisolatie Aanbrengen',
    'Gevelbekleding Installeren (Hout, Kunststof, Metaal, Steen, Glas)',
    'Scheuren in Gevels Herstellen',
    'Raamdorpels/Lateien Vervangen/Plaatsen',
    'Gevelbescherming (Graffiti/Vervuiling)',
    'Vochtwerende Barrières Aanbrengen',
    'Kleur-/Materiaalkeuzes Gevelrenovatie Advies',
    'Gevels Constructieve Veiligheid Controleren',
    'Steenstrips/Decoratieve Gevelelementen Installeren',
    'Historische/Monumentale Gevels Onderhouden',
    'Gevelinspectie & Onderhouds/Restauratieadvies',
    'Thermografische Inspecties (Warmtelekken)',
    'Gevels Behandelen (Algen, Mossen, Schimmels)',
    'Gevelbeplating (Bedrijfspanden/Industriële Gebouwen)',
    'Offertes/Overeenkomsten Gevelwerkzaamheden'
  ];
  

describe('Testing "Gevelspecialist"', () => {
