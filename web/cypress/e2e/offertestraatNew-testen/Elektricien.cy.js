...
const terms = [
    'Nieuwe Elektrische Bedrading Installatie',
    'Elektrische Systeem Reparatie',
    'Elektrische Onderhoud',
    'Groepenkast Werkzaamheden',
    'Verlichtingsarmaturen Werkzaamheden',
    'Stopcontacten Werkzaamheden',
    'Elektrische Aarding Veiligstellen',
    'Elektrische Inspecties',
    'Data/Communicatiebedrading Werkzaamheden',
    'Beveiligingssystemen Installatie',
    'Domotica/Smart Home Installatie',
    'Generatoren/Noodstroom Installatie',
    'Energiezuinige Oplossingen Advies',
    'Elektrische Verwarmingssystemen Werkzaamheden',
    'Ventilatie/Airco Elektrische Aansluitingen',
    'Grote Elektrische Apparaten Aansluiting/Reparatie'
  ];

describe('Testing "Elektricien"', () => {
