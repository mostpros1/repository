...
const terms = [
    'CV-Ketels/Combiketels Installatie',
    'Radiatoren/Convectoren Plaatsing',
    'Vloerverwarmingssystemen Aanleggen',
    'Warmtepompen/Zonneboilers Installeren',
    'Verwarmingsinstallaties Onderhoud/Reparatie',
    'Thermostaten/Regelsystemen Onderhoud',
    'Ventilatie/Luchtbehandelingssystemen Installatie',
    'Gasleidingen Voor Verwarmingstoestellen',
    'Storingen Verwarmingssystemen Oplossen',
    'Inspecties/Keuringen Verwarmingsinstallaties',
    'Onderdelen Vervangen',
    'Energiezuinige Verwarmingsoplossingen Advies',
    'Pelletkachels/Biomassaketels Installeren',
    'Verwarmingssystemen Afstellen',
    'Samenwerking Andere Vakmensen',
    'Lucht-Water/Water-Water Warmtepompen',
    'Verwarmingssystemen op Hernieuwbare Energie Aansluiten',
    'Leidingen Voor Verwarmingssystemen Aanleggen',
    'Verwarmingssystemen Uitbreiden',
    'Onderhoud/Gebruik Verwarmingsinstallaties Advies'
  ];

describe('Testing "Verwarmingsinstallateur"', () => {
