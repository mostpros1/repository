...
const terms = [
    'Laadpaal Type Advies',
    'Elektrische Voertuig Laadpalen Installatie',
    'Laadpalen Onderhoud/Reparatie',
    'Bestaande Laadinfrastructuur Upgraden',
    'Stroomcapaciteit Analyse (Woning/Bedrijfspand)',
    'Laadbeheersystemen Installatie',
    'Extra Elektrische Groepen Aanleggen',
    'Storingen aan Laadpalen Oplossen',
    'Laadpalen Integratie (Energiemanagement/Zonnepanelen)',
    'Snelladers Installatie (Bedrijven/Openbare Locaties)',
    'Veiligheidscontroles/Keuringen Laadinfrastructuur',
    'Subsidiemogelijkheden/Fiscale Voordelen Advies',
    'Signalisatie/Markeringen voor Laadplekken Plaatsing',
    'Laadtarieven/Beheersoftware Configuratie',
    'Optimale Locatie Laadpalen Advies',
    'Slimme Laadpalen Installatie (Piekbelasting Vermijden)',
    'Reguliere Laadpalen/Snelladers Keuze Ondersteuning',
    'Periodieke Inspectie/Kalibratie van Laadpalen',
    'Toekomstige Uitbreidingen Adviseren',
    'Bekabeling/Infrastructuur voor Laadpalen Aanleggen'
  ];

describe('Testing "Laadpaalspecialist"', () => {
