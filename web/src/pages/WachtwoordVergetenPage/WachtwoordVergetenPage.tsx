...
const WachtwoordVergetenPage = () => {
  ...
  const onSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!codeSent) {
      ...
      let code: string = "";
      codeInputRef.current.forEach((input: HTMLInputElement) => {
        code += input.value;
      });
  ...
  return (
    <div
      className={
        codeSent
          ? "resetpassword-container codesent"
          : "resetpassword-container"
      }
    >
      <form
        className={
          codeSent ? "resetpassword-card codesent" : "resetpassword-card"
        }
        onSubmit={onSubmit}
      >
        ...
        <div className="resetpasswordform-middletext">
          <b className="resetpassword-card_text">
            Voer uw email in om uw wachtwoord te wijzigen.
          </b>
          <p className="resetpassword-card_longtext">
            Zoek daarna in uw inbox naar een code, en voer die hieronder in. Let
            op: de mail kan mogelijk in uw spamfolder beland zijn.
          </p>
        </div>
          ...
          <>
            ...
            <div className="resetpassword-form_field">
              ...
              <input
                ...
                onChange={(e) =>
                  setFields({ ...fields, repeatNewPassword: e.target.value })
                }
              />
            </div>
          </>
        )}
        <div className="resetpassword-card-buttoncontainer">
          <button className="resetpassword-card_button" type="submit">
            Bevestigen
          </button>
          <button
            type="button"
        ...
        {codeSent && (
          <a
            className="confirmemail-card_newCode"
            onClick={() => Auth.forgotPassword(fields.email)}
          >
