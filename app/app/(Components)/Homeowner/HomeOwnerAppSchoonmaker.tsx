...
const HomeOwnerAppSchoonmaker = ({ navigation }) => {
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.cardsContainer}>
                    <View style={styles.card}>
                        ...
                        />
                        <Image source={require("../../../assets/images/schoonmakerone.png")} style={styles.cardImage} />
                        <Text style={styles.cardTitle}>Glazenwassen</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        />
                        <Image source={require("../../../assets/images/schoonmakertwo.png")} style={styles.cardImage} />
                        <Text style={styles.cardTitle}>Schoonmaak daken of dakgoten</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        />
                        <Image source={require("../../../assets/images/schoonmakerthree.png")} style={styles.cardImage} />
                        <Text style={styles.cardTitle}>Schoonmaak rolluiken</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        />
                        <Image source={require("../../../assets/images/schoonmakerfour.png")} style={styles.cardImage} />
                        <Text style={styles.cardTitle}>Onderhoud en reparatie zonnepanelen</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        />
                        <Image source={require("../../../assets/images/schoonmakerfive.png")} style={styles.cardImage} />
                        <Text style={styles.cardTitle}>Schoonmaak huis of bedrijfspand met robot</Text>
                    </View>
...
export default HomeOwnerAppSchoonmaker;
