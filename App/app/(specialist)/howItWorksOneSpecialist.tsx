        ...
        <SafeAreaView style={styles.view}>
            <View style={styles.topContainer}>
                ...
                <View style={styles.imageContainer}>
                    <View>
                        <Image style={styles.image} source={require("../../assets/images/howItWorksFour.png")} />
                    </View>
                </View>
            </View>
            ...
            <View style={styles.middleContainer}>
                ...
                <View style={styles.middleContainerSecondSection}>
                    <Text>Voer in de zoekbalk de type klus die je zoekt, noteer je postcode en krijg klussen van mensen in jouw omgeving. Let op: U dient aan het einde in te loggen om aanbod te ontvangen.</Text>
                </View>
            </View>
            ...
            <Link style={styles.link} href="/howItWorksTwoSpecialist">
