...
var InMemoryCacheClass = /** @class */ (function (_super) {
    tslib_1.__extends(InMemoryCacheClass, _super);
    /**
    ...
    InMemoryCacheClass.prototype.clear = function () {
        ...
        for (var i = 0; i < this.maxPriority; i += 1) {
            try {
                for (var _b = (e_1 = void 0, tslib_1.__values(this.cacheList[i].getKeys())), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key = _c.value;
    ...
    InMemoryCacheClass.prototype.getAllKeys = function () {
        ...
        for (var i = 0; i < this.maxPriority; i += 1) {
            try {
                for (var _b = (e_2 = void 0, tslib_1.__values(this.cacheList[i].getKeys())), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key = _c.value;
