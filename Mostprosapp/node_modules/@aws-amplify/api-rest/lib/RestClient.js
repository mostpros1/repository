            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        _b = (0, url_1.parse)(url, true, true), search = _b.search, parsedUrl = tslib_1.__rest(_b, ["search"]);
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, (0, axios_1.default)(signedParams)];
                    case 8:
                        response = _c.sent();
                    ...
                    case 9:
                        ...
                        if (core_1.DateUtils.isClockSkewError(error_2)) {
                            ...
                            if (core_1.DateUtils.isClockSkewed(responseDate)) {
                                rawClientDate = requestDate.getTime() - core_1.DateUtils.getClockOffset();
                                core_1.DateUtils.setClockOffset(responseDate.getTime() - rawClientDate);
