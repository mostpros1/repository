...
const HomeOwnerAppBadkamerspecialist = ({ navigation }) => {
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.cardsContainer}>
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Badkamerontwerp</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Sanitair/tegels/inrichting advies</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Douches/baden/wastafels/toiletten installatie</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Waterleidingen/afvoeren aanleggen</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Badkamermeubels/-kasten plaatsen</Text>
                    </View>
...
export default HomeOwnerAppBadkamerspecialist;
