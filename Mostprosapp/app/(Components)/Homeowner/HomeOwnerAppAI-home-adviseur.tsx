...
const HomeOwnerAppAI_home_adviseur = ({ navigation }) => {
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.cardsContainer}>
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Woonbehoeften analyseren voor AI-oplossingen</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>Advies over AI-gestuurde huishoudelijke apparaten</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>AI-beveiligingssystemen opzetten/configureren</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>AI-functionaliteiten in smart home systemen integreren</Text>
                    </View>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardTitle}>AI-spraakassistenten installeren/configureren</Text>
                    </View>
...
export default HomeOwnerAppAI_home_adviseur;
