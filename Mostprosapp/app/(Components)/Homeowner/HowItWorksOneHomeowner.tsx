    ...
    <SafeAreaView style={styles.view}>
      <View style={styles.topContainer}>
        ...
        <View style={styles.imageContainer}>
          <View>
            <Image
              style={styles.image}
              source={require("../../../assets/images/HowItWorksOne.png")}
            />
          </View>
        </View>
      </View>
      ...
      <View style={styles.middleContainer}>
        <View style={styles.middleContainerFirstSection}>
          ...
          <Text style={styles.title}>Beschrijf de klus</Text>
        </View>
        <View style={styles.middleContainerSecondSection}>
          <Text>
          Voer eerst uw klus en postcode in. Beschrijf vervolgens uw werkzaamheden en log in om uw persoonlijke aanbod te ontvangen. We zijn er om u te helpen!
          </Text>
        </View>
      </View>
