...
const CompanySituation1 = ({ navigation }) => {
    ...
    const handleNext = () => {
        if (selectedItems.length === 0) {
            ...
            navigation.navigate("CompanySituation2");
        }
    };
        ...
        <SafeAreaView>
            <ScrollView contentContainerStyle={styles.scrollViewContainer}>
                <SafeAreaView style={styles.container}>
                    ...
                    <Pressable testID="situatie-1 Keuze-1" style={[styles.pressableContainer]} onPress={() => toggleItemSelection(1)}>
                    ...
                    <Pressable testID="situatie-1 Keuze-2" style={[styles.pressableContainer]} onPress={() => toggleItemSelection(2)}>
                    ...
                    <Pressable testID="situatie-1 Keuze-3" style={[styles.pressableContainer]} onPress={() => toggleItemSelection(3)}>
                    ...
                    <Pressable testID="situatie-1 Keuze-4" style={[styles.pressableContainer]} onPress={() => toggleItemSelection(4)}>
                    ...
                    <Pressable testID="situatie-1 Keuze-5" style={[styles.pressableContainer]} onPress={() => toggleItemSelection(5)}>
                    ...
                    <View style={styles.buttonsContainer}>
                        <Pressable testID="vorigeBtn-3" style={[styles.nextButton, styles.nextButtonColorOne]} onPress={() => navigation.goBack()}>
                            <Text style={styles.nextButtonText}>Vorige</Text>
                        </Pressable>
                        <Pressable testID="volgendeBtn-4" style={[styles.nextButton]} onPress={handleNext}>
